...
object PluginProtocol {
    ...
    const val ACTION_STICKER_PLUGIN = "com.example.stickerhelper.STICKER_PLUGIN"

    // Meta-data key in plugin manifest for display name
    const val META_PLUGIN_NAME = "com.example.stickerhelper.plugin_name"
    const val META_PLUGIN_AUTHOR = "com.example.stickerhelper.plugin_author"
    const val META_PLUGIN_VERSION = "com.example.stickerhelper.plugin_version"
    const val META_PLUGIN_DESCRIPTION = "com.example.stickerhelper.plugin_description"
